                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Бронирование чипов</li>
                            </ol>                            
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="card-title">Бронирование чипов</h5>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            $(".delete_cat").on('click', function(){
                ...
                $.ajax({
                    method: "POST",
                    url: "/admin/reservecontroller/delete_chip",
                    data: {'id': cat_id},
                }).done(function(){
                    window.location="/admin/reserve_chip";
                });
            });
        </script>