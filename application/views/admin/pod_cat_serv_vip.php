    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Подкатегория VIP бронирование</h4>
            </div>
                ...
                <div class="col-lg-4 col-xlg-3 col-md-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <center class="m-t-30">
                                <a href="/admin/vip_view/<?php echo $row->id ?>">
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_add_uslugi" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <br>
                <br>
                <input type="" id="cat_id" name="cat_id" value="<?= $cat_two_id;?>">
                <button id="add_service_lang" class="btn btn-success" data-lang="Английского языка">Добавить поле для следующего языка</button>
                <input id="add_uslugi" class="w3-button w3-indigo" data-url_insert="/admin/vip_add" type="submit" value="button" style="float:right;">
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_update" class="w3-container" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="update_cat_two" class="w3-button w3-indigo" data-url_update="/admin/vip_upd" type="submit" value="Изменить" style="float:right;">
            </form>
        </div>
    </div>
</div>
...
<input type="hidden" id="base_url" value="<?= base_url('/admin/services_vip/'.$cat_two_id);?>" style="width: 100%">
