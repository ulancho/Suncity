                ...
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30">
                            ...
                            >Update</button>
                            <button type="button" class="btn btn-danger open-modal perehod_three"
                                    data-modalka_id="#modal_delete_three"
                                    data-id="<?php echo $category->id?>"
                                    data-img="<?php echo $category->image_name?>"
                            >Удалить</button>
                        </center>
...
<!-- start for delete-->
<div class="modals" id="modal_delete_three">
    <div class="maska close-modal" data-modalka_id="#modal_delete_three"></div>
    <div class="modal_content" style="height:150px;">
        <span class="close_modal close-modal" data-modalka_id="#modal_delete_three">
...
<script src="<?php echo base_url()?>assets/admin/dist/js/script_cat_three.js"></script>
