                        ...
                        <div class="card-body">
                            <center class="m-t-30"><img src="<?=$image?>" width="300" class="img-thumbnail"/>
                                ...
                                <button data-id="<?=$row->id?>"
                                        data-img="<?=$row->img_name?>"
                                        data-url_delete="/admin/show_del_view"
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_add_uslugi" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="add_reserv_view" data-url_insert="/admin/show_insert_view" class="w3-button w3-indigo" type="submit" value="Добавить" style="float:right;">
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_update" class="w3-container" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="update_cat_two" data-url_update="/admin/show_upd_view" class="w3-button w3-indigo" type="submit" value="Изменить" style="float:right;">
            </form>
        </div>
    </div>
</div>
...
<input type="hidden" id="base_url" value="<?= base_url('/admin/rest_show/'.$sub_cat_id);?>" style="width: 100%">
