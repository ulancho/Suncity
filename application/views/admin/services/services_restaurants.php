                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"><img src="<?=$image?>" width="300" class="img-thumbnail"/>
                                    ...
                                    <button id="edit_cat<?= $row->id;?>" data-id="<?=$row->id?>"
                                    ...
                                    <button data-id="<?=$row->id?>" data-img="<?=$row->img_name?>"
                                            data-url_delete="/admin/rest_del_view" type="button" class="delete_serv_res btn btn-danger">Delete</button>
                                </center>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_add_uslugi" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="add_reserv_view" data-url_insert="/admin/rest_add_view" class="w3-button w3-indigo" type="submit" value="Добавить" style="float:right;">
            </form>
            <br>
        </div>
    </div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_update" class="w3-container" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="update_cat_two" data-url_update="/admin/rest_edit_view" class="w3-button w3-indigo" type="submit" value="Изменить" style="float:right;">
            </form>
        </div>
    </div>
</div>

        <input type="hidden" id="base_url" value="<?= base_url('/admin/rest_view/'.$sub_cat_id);?>" style="width: 100%">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
        <script src="<?php echo base_url()?>assets/admin/dist/js/script_serv_res_view.js"></script>
