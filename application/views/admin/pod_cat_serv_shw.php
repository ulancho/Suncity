    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Подкатегория Шоу бронирование</h4>
            </div>
                ...
                <div class="col-lg-4 col-xlg-3 col-md-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <center class="m-t-30">
                                <a href="/admin/rest_show/<?php echo $row->id ?>">
                                ...
                                <button data-id="<?=$row->id?>"
                                        ...
                                        data-url_delete="/admin/show_del"
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_add_uslugi" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="add_uslugi" class="w3-button w3-indigo" data-url_insert="/admin/add_show" type="submit" value="button" style="float:right;">
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_update" class="w3-container" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="update_cat_two" class="w3-button w3-indigo" data-url_update="/admin/show_upd" type="submit" value="Изменить" style="float:right;">
            </form>
        </div>
    </div>
</div>
...
<input type="hidden" id="base_url" value="<?= base_url('/admin/show/'.$cat_two_id);?>" style="width: 100%">
