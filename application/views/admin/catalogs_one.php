                ...
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30">
                            ...
                            >Update</button>
                            <button type="button" class="btn btn-danger delete_cat open-modal"
                                    data-modalka_id="#modal_delete"
                                    data-id="<?php echo $category->id?>"
                                    data-img="<?php echo $category->image_name?>"
                            >Delete</button>
                        </center>
...
<!-- ============================================================== -->
<!-- start for delete-->
<div class="modals" id="modal_delete">
    <div class="maska close-modal" data-modalka_id="#modal_delete"></div>
    <div class="modal_content" style="height:150px;">
        <span class="close_modal close-modal" data-modalka_id="#modal_delete">
            <i class="material-icons">close</i>
        </span>
        <div class="content" style="text-align: center">
            <form id="forma_del" class="w3-container"  action="javascript:void(0)" method="post">
                <input name="id" type="hidden" id="id_del">
                <input name="img" type="hidden" id="img_name_del">
                <input class="csrf" type="hidden" name="<?php echo $name?>" value="<?php echo $hash?>">
                Вы уверены, что хотите удалить?
                <button type="button" class="btn btn-danger delete_cat_one">Да,удалить</button>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal_content">
        ...
        <div class="content">
            ...
            <form id="forma_add" class="w3-container"  action="javascript:void(0)" method="post" enctype="multipart/form-data">
                ...
                <input id="add_cat_one" class="" type="submit" value="Добавить" style="float:right;">
            </form>
