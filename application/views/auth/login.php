...
<body>
    ...
    <div id="login">
            ...
            echo '<p><span class="fontawesome-user"></span>'. form_input(array('placeholder'=> "$param_log",'name' => 'login', 'value' => set_value('login'))) .'</p>';
...
<!--        <p>Нет аккаунта? &nbsp;&nbsp;<a href="<?php echo site_url('auth/signup'); ?>">Регистрация</a><span class="fontawesome-arrow-right"></span></p>-->
    </div>
