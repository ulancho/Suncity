...
<body>
    ...
    <div id="login">
        ...
        echo '<p><span class="fontawesome-user"></span>'.form_input(array('placeholder'=> 'логин@gmail.com','name' => 'email', 'value' => set_value('email'))) .'</p>';
        echo form_error('email');
        echo '<p><span class="fontawesome-user"></span>'.form_input(array('placeholder'=> 'Логин','name' => 'fio', 'value' => set_value('fio'))) .'</p>';
        echo form_error('fio');
