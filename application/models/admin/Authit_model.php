...
class Authit_model extends CI_Model {
	...
	{
		$query = $this->db->get_where($this->users_table, array('login' => $email));
		if($query->num_rows()) return $query->row();
		return false;
	}
...
//	
//	public function create_user($email, $password, $fio)
//	{
//		$data = array(
...
//		$this->dbforge->add_field('fio VARCHAR(200) NOT NULL');
